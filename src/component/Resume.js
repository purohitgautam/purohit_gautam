    ...
    <div className="resume">
      <div>
        <VerticalTimeline lineColor='#3e497a'>
          ...
          >
            <h4 className='vertical-timeline-element-title'>Graduation In B.com</h4>
            <p className='vertical-timeline-element-title'>at <b>Veer Narmad South Gujarat University</b></p>
          ...
          >
            <h4 className='vertical-timeline-element-title'>working in diamond industry</h4>
            <p className='vertical-timeline-element-title'>Post : <b>Galaxy Planner</b></p>
            <p className='vertical-timeline-element-title'>Surat, Gujarat</p>
            <p className='vertical-timeline-element-title'>India</p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
           ...
           icon={<MdSchool color='white' />}
          >
            <h4 className='vertical-timeline-element-title'>Learning Frontend Web Development</h4>
          </VerticalTimelineElement>
          <VerticalTimelineElement
           className='vertical-timeline-element-education' 
           date='Present' 
          ...
          >
            <h4 className='vertical-timeline-element-title'>Working In Bugsfree Technologies, Ahamadabad</h4>
            <p className='vertical-timeline-element-title'>Post : <b>Web Developer Intern</b>(remote)</p>
          </VerticalTimelineElement>
        </VerticalTimeline>
